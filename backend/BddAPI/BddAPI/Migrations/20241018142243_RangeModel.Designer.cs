...
namespace BddAPI.Migrations
{
    ...
    [Migration("20241018142243_RangeModel")]
    partial class RangeModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BddAPI.Models.ContractDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("Bail")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("LocalBoardAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("LocalBoardArea")
                        .HasColumnType("float");

                    b.Property<string>("LocalBoardName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BddAPI.Models.RecordDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BddAPI.Models.RequestDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BddAPI.Models.Reservation", b =>
                {
                    ...
                    b.Property<Guid?>("RecordDocumentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("RequestDocumentId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BddAPI.Models.Reservation", b =>
                {
                    b.HasOne("BddAPI.Models.CommunityHome", "CommunityCenter")
                        .WithMany()
                        .HasForeignKey("CommunityCenterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BddAPI.Models.ContractDocument", "ContractDocument")
                        .WithMany()
                        .HasForeignKey("ContractDocumentId");

                    b.HasOne("BddAPI.Models.RecordDocument", "RecordDocument")
                        .WithMany()
                        .HasForeignKey("RecordDocumentId");

                    b.HasOne("BddAPI.Models.RequestDocument", "RequestDocument")
                        .WithMany()
