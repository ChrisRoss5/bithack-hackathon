...
Frontend (Vue 3 + Vite + Tailwind/DaisyUI + Pinia):
...
Backend (.NET 8, EF Core, SQL Server, JWT):

```
cd app/backend/BddAPI
dotnet run --project BddAPI
```

Firebase Hosting serves `app/frontend/dist` → https://bjelovar-drustveni-domovi.web.app
